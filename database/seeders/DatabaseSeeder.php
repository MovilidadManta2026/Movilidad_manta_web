...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['inicio', 'shortcut.rtv', 'RTV Matriculación', 'Información de revisión técnica vehicular y matriculación.', 15, ['placement' => 'shortcut', 'category' => 'rtv', 'icon' => 'tv', 'url' => 'https://wt.movilidadmanta.gob.ec/webturnos/login.aspx']],
            ...
            ['inicio', 'shortcut.sgi', 'Sistema de Gestión Interno SGI', 'Acceso al sistema de gestión interno institucional.', 17, ['placement' => 'shortcut', 'category' => 'sgi', 'icon' => 'chart', 'url' => 'https://sgi.movilidadmanta.gob.ec/login']],
            ['inicio', 'shortcut.intranet', 'Intranet', 'Ingreso a recursos internos y plataformas institucionales.', 18, ['placement' => 'shortcut', 'category' => 'intranet', 'icon' => 'globe', 'url' => 'https://intranet.movilidadmanta.gob.ec:8080/']],
